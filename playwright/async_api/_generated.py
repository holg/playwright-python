...
class Request(AsyncBase):
    ...
    async def response(self) -> typing.Optional["Response"]:
        ...
        return mapping.from_impl_nullable(await self._async("request.response", self._impl_obj.response()))
...
class Response(AsyncBase):
    ...
    async def finished(self) -> typing.Optional[str]:
        ...
        return mapping.from_maybe_impl(await self._async("response.finished", self._impl_obj.finished()))
    ...
    async def body(self) -> bytes:
        ...
        return mapping.from_maybe_impl(await self._async("response.body", self._impl_obj.body()))
    ...
    async def text(self) -> str:
        ...
        return mapping.from_maybe_impl(await self._async("response.text", self._impl_obj.text()))
    ...
    async def json(self) -> typing.Any:
        ...
        return mapping.from_maybe_impl(await self._async("response.json", self._impl_obj.json()))
...
class Route(AsyncBase):
    ...
    async def abort(self,
        ...
        return mapping.from_maybe_impl(await self._async("route.abort", self._impl_obj.abort(errorCode=error_code)))
    ...
    async def fulfill(self,
                *,
                ...
                content_type: str = None) -> NoneType:
        """Route.fulfill
        ...
        return mapping.from_maybe_impl(await self._async("route.fulfill", self._impl_obj.fulfill(status=status,
    ...
    async def continue_(self,
                  *,
                  ...
                  method: str = None,
                  headers: typing.Optional[typing.Dict[str, str]] = None,
                  post_data: typing.Union[str, bytes] = None) -> NoneType:
        """Route.continue_
        ...
        return mapping.from_maybe_impl(await self._async("route.continue_", self._impl_obj.continue_(url=url,
                                                                                      method=method,
                                                                                      headers=mapping.to_impl(headers),
                                                                                      postData=post_data)))
...
class WebSocket(AsyncBase):
    ...
    def expect_event(self,
                     ...
                     *,
                     timeout: float = None) -> AsyncEventContextManager:
        ...
        return AsyncEventContextManager(self._impl_obj.expect_event(event=event,
    ...
    async def wait_for_event(self,
        ...
        return mapping.from_maybe_impl(await self._async("web_socket.wait_for_event", self._impl_obj.wait_for_event(event=event,
                                                                                                     predicate=self._wrap_handler(predicate),
                                                                                                     timeout=timeout)))
...
class Keyboard(AsyncBase):
    ...
    async def down(self,
        ...
        return mapping.from_maybe_impl(await self._async("keyboard.down", self._impl_obj.down(key=key)))
    ...
    async def up(self,
        ...
        return mapping.from_maybe_impl(await self._async("keyboard.up", self._impl_obj.up(key=key)))

    async def insert_text(self,
                    text: str) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("keyboard.insert_text", self._impl_obj.insert_text(text=text)))

    async def type(self,
             text: str,
             *,
             delay: float = None) -> NoneType:
        """Keyboard.type
        ...
        return mapping.from_maybe_impl(await self._async("keyboard.type", self._impl_obj.type(text=text,
                                                                               delay=delay)))
    ...
    async def press(self,
        ...
        return mapping.from_maybe_impl(await self._async("keyboard.press", self._impl_obj.press(key=key,
                                                                                 delay=delay)))
...
class Mouse(AsyncBase):
    ...
    async def move(self,
        ...
        return mapping.from_maybe_impl(await self._async("mouse.move", self._impl_obj.move(x=x,
                                                                            y=y,
                                                                            steps=steps)))
    ...
    async def down(self,
        ...
        return mapping.from_maybe_impl(await self._async("mouse.down", self._impl_obj.down(button=button,
    ...
    async def up(self,
        ...
        return mapping.from_maybe_impl(await self._async("mouse.up", self._impl_obj.up(button=button,
                                                                        clickCount=click_count)))
    ...
    async def click(self,
        ...
        return mapping.from_maybe_impl(await self._async("mouse.click", self._impl_obj.click(x=x,
                                                                              y=y,
                                                                              delay=delay,
                                                                              button=button,
                                                                              clickCount=click_count)))
    ...
    async def dblclick(self,
                 ...
                 *,
                 delay: float = None,
                 button: Literal['left', 'middle', 'right'] = None) -> NoneType:
        """Mouse.dblclick
        ...
        return mapping.from_maybe_impl(await self._async("mouse.dblclick", self._impl_obj.dblclick(x=x,
                                                                                    y=y,
                                                                                    delay=delay,
                                                                                    button=button)))
...
class Touchscreen(AsyncBase):
    ...
    async def tap(self,
        ...
        return mapping.from_maybe_impl(await self._async("touchscreen.tap", self._impl_obj.tap(x=x,
                                                                                y=y)))
...
class JSHandle(AsyncBase):
    ...
    async def evaluate(self,
                 expression: str,
                 arg: typing.Any = None) -> typing.Any:
        """JSHandle.evaluate
        ...
        return mapping.from_maybe_impl(await self._async("js_handle.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                                        arg=mapping.to_impl(arg))))

    async def evaluate_handle(self,
                        expression: str,
                        arg: typing.Any = None) -> "JSHandle":
        ...
        return mapping.from_impl(await self._async("js_handle.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                                arg=mapping.to_impl(arg))))

    async def get_property(self,
                     property_name: str) -> "JSHandle":
        ...
        return mapping.from_impl(await self._async("js_handle.get_property", self._impl_obj.get_property(propertyName=property_name)))
    ...
    async def get_properties(self) -> typing.Dict[str, "JSHandle"]:
        ...
        return mapping.from_impl_dict(await self._async("js_handle.get_properties", self._impl_obj.get_properties()))
    ...
    async def dispose(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("js_handle.dispose", self._impl_obj.dispose()))
    ...
    async def json_value(self) -> typing.Any:
        ...
        return mapping.from_maybe_impl(await self._async("js_handle.json_value", self._impl_obj.json_value()))
...
class ElementHandle(JSHandle):
    ...
    async def owner_frame(self) -> typing.Optional["Frame"]:
        ...
        return mapping.from_impl_nullable(await self._async("element_handle.owner_frame", self._impl_obj.owner_frame()))
    ...
    async def content_frame(self) -> typing.Optional["Frame"]:
        ...
        return mapping.from_impl_nullable(await self._async("element_handle.content_frame", self._impl_obj.content_frame()))
    ...
    async def get_attribute(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.get_attribute", self._impl_obj.get_attribute(name=name)))
    ...
    async def text_content(self) -> typing.Optional[str]:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.text_content", self._impl_obj.text_content()))
    ...
    async def inner_text(self) -> str:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.inner_text", self._impl_obj.inner_text()))
    ...
    async def is_checked(self) -> bool:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.is_checked", self._impl_obj.is_checked()))
    ...
    async def is_disabled(self) -> bool:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.is_disabled", self._impl_obj.is_disabled()))
    ...
    async def is_enabled(self) -> bool:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.is_enabled", self._impl_obj.is_enabled()))
    ...
    async def is_hidden(self) -> bool:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.is_hidden", self._impl_obj.is_hidden()))
    ...
    async def is_visible(self) -> bool:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.is_visible", self._impl_obj.is_visible()))

    async def dispatch_event(self,
                       type: str,
                       event_init: typing.Dict = None) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.dispatch_event", self._impl_obj.dispatch_event(type=type,
                                                                                                         eventInit=mapping.to_impl(event_init))))

    async def scroll_into_view_if_needed(self,
                                   *,
                                   timeout: float = None) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.scroll_into_view_if_needed", self._impl_obj.scroll_into_view_if_needed(timeout=timeout)))
    ...
    async def hover(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.hover", self._impl_obj.hover(modifiers=modifiers,
                                                                                       position=position,
                                                                                       timeout=timeout,
                                                                                       force=force)))
    ...
    async def click(self,
              *,
              ...
              timeout: float = None,
              force: bool = None,
              no_wait_after: bool = None) -> NoneType:
        """ElementHandle.click
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.click", self._impl_obj.click(modifiers=modifiers,
                                                                                       position=position,
                                                                                       delay=delay,
                                                                                       button=button,
                                                                                       clickCount=click_count,
    ...
    async def dblclick(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.dblclick", self._impl_obj.dblclick(modifiers=modifiers,
                                                                                             position=position,
                                                                                             delay=delay,
                                                                                             button=button,
                                                                                             timeout=timeout,
    ...
    async def select_option(self,
                      ...
                      *,
                      ...
                      timeout: float = None,
                      no_wait_after: bool = None) -> typing.List[str]:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.select_option", self._impl_obj.select_option(value=value,
                                                                                                       index=index,
                                                                                                       label=label,
    ...
    async def tap(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.tap", self._impl_obj.tap(modifiers=modifiers,
                                                                                   position=position,
                                                                                   timeout=timeout,
                                                                                   force=force,
                                                                                   noWaitAfter=no_wait_after)))
    ...
    async def fill(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.fill", self._impl_obj.fill(value=value,
                                                                                     timeout=timeout,
                                                                                     noWaitAfter=no_wait_after)))
    ...
    async def select_text(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.select_text", self._impl_obj.select_text(timeout=timeout)))

    async def set_input_files(self,
                        files: typing.Union[str, pathlib.Path, FilePayload, typing.List[typing.Union[str, pathlib.Path]], typing.List[FilePayload]],
                        *,
                        timeout: float = None,
                        no_wait_after: bool = None) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.set_input_files", self._impl_obj.set_input_files(files=files,
                                                                                                           timeout=timeout,
                                                                                                           noWaitAfter=no_wait_after)))
    ...
    async def focus(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.focus", self._impl_obj.focus()))
    ...
    async def type(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.type", self._impl_obj.type(text=text,
                                                                                     delay=delay,
                                                                                     timeout=timeout,
                                                                                     noWaitAfter=no_wait_after)))
    ...
    async def press(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.press", self._impl_obj.press(key=key,
                                                                                       delay=delay,
                                                                                       timeout=timeout,
                                                                                       noWaitAfter=no_wait_after)))
    ...
    async def check(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.check", self._impl_obj.check(timeout=timeout,
                                                                                       force=force,
                                                                                       noWaitAfter=no_wait_after)))
    ...
    async def uncheck(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.uncheck", self._impl_obj.uncheck(timeout=timeout,
                                                                                           force=force,
                                                                                           noWaitAfter=no_wait_after)))
    ...
    async def bounding_box(self) -> typing.Optional[FloatRect]:
        ...
        return mapping.from_impl_nullable(await self._async("element_handle.bounding_box", self._impl_obj.bounding_box()))
    ...
    async def screenshot(self,
                   *,
                   ...
                   path: typing.Union[str, pathlib.Path] = None,
                   quality: int = None,
                   omit_background: bool = None) -> bytes:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.screenshot", self._impl_obj.screenshot(timeout=timeout,
                                                                                                 type=type,
                                                                                                 path=path,
                                                                                                 quality=quality,
    ...
    async def query_selector(self,
                       selector: str) -> typing.Optional["ElementHandle"]:
        ...
        return mapping.from_impl_nullable(await self._async("element_handle.query_selector", self._impl_obj.query_selector(selector=selector)))

    async def query_selector_all(self,
                           selector: str) -> typing.List["ElementHandle"]:
        ...
        return mapping.from_impl_list(await self._async("element_handle.query_selector_all", self._impl_obj.query_selector_all(selector=selector)))

    async def eval_on_selector(self,
                         selector: str,
                         expression: str,
                         arg: typing.Any = None) -> typing.Any:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.eval_on_selector", self._impl_obj.eval_on_selector(selector=selector,
                                                                                                             expression=expression,
                                                                                                             arg=mapping.to_impl(arg))))

    async def eval_on_selector_all(self,
                             selector: str,
                             expression: str,
                             arg: typing.Any = None) -> typing.Any:
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.eval_on_selector_all", self._impl_obj.eval_on_selector_all(selector=selector,
                                                                                                                     expression=expression,
                                                                                                                     arg=mapping.to_impl(arg))))

    async def wait_for_element_state(self,
        ...
        return mapping.from_maybe_impl(await self._async("element_handle.wait_for_element_state", self._impl_obj.wait_for_element_state(state=state,
                                                                                                                         timeout=timeout)))
    ...
    async def wait_for_selector(self,
                          ...
                          *,
                          ...
                          timeout: float = None) -> typing.Optional["ElementHandle"]:
        ...
        return mapping.from_impl_nullable(await self._async("element_handle.wait_for_selector", self._impl_obj.wait_for_selector(selector=selector,
                                                                                                                  state=state,
                                                                                                                  timeout=timeout)))
...
class Accessibility(AsyncBase):
    ...
    async def snapshot(self,
                 *,
                 interesting_only: bool = None,
                 root: "ElementHandle" = None) -> typing.Optional[typing.Dict]:
        ...
        return mapping.from_maybe_impl(await self._async("accessibility.snapshot", self._impl_obj.snapshot(interestingOnly=interesting_only,
                                                                                            root=mapping.to_impl(root))))
...
class FileChooser(AsyncBase):
    ...
    async def set_files(self,
        ...
        return mapping.from_maybe_impl(await self._async("file_chooser.set_files", self._impl_obj.set_files(files=files,
                                                                                             timeout=timeout,
                                                                                             noWaitAfter=no_wait_after)))
...
class Frame(AsyncBase):
    ...
    async def goto(self,
             ...
             *,
             ...
             referer: str = None) -> typing.Optional["Response"]:
        """Frame.goto
        ...
        return mapping.from_impl_nullable(await self._async("frame.goto", self._impl_obj.goto(url=url,
                                                                               timeout=timeout,
    ...
    def expect_navigation(self,
                          *,
                          ...
                          wait_until: Literal['domcontentloaded', 'load', 'networkidle'] = None,
                          timeout: float = None) -> AsyncEventContextManager["Response"]:
        ...
        return AsyncEventContextManager(self._impl_obj.expect_navigation(url=self._wrap_handler(url),
    ...
    async def wait_for_load_state(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.wait_for_load_state", self._impl_obj.wait_for_load_state(state=state,
                                                                                                          timeout=timeout)))
    ...
    async def frame_element(self) -> "ElementHandle":
        ...
        return mapping.from_impl(await self._async("frame.frame_element", self._impl_obj.frame_element()))
    ...
    async def evaluate(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                                    arg=mapping.to_impl(arg))))
    ...
    async def evaluate_handle(self,
        ...
        return mapping.from_impl(await self._async("frame.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                            arg=mapping.to_impl(arg))))
    ...
    async def query_selector(self,
        ...
        return mapping.from_impl_nullable(await self._async("frame.query_selector", self._impl_obj.query_selector(selector=selector)))
    ...
    async def query_selector_all(self,
        ...
        return mapping.from_impl_list(await self._async("frame.query_selector_all", self._impl_obj.query_selector_all(selector=selector)))

    async def wait_for_selector(self,
                          selector: str,
                          *,
                          timeout: float = None,
                          state: Literal['attached', 'detached', 'hidden', 'visible'] = None) -> typing.Optional["ElementHandle"]:
        ...
        return mapping.from_impl_nullable(await self._async("frame.wait_for_selector", self._impl_obj.wait_for_selector(selector=selector,
                                                                                                         timeout=timeout,
                                                                                                         state=state)))
    ...
    async def is_checked(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.is_checked", self._impl_obj.is_checked(selector=selector,
                                                                                        timeout=timeout)))
    ...
    async def is_disabled(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.is_disabled", self._impl_obj.is_disabled(selector=selector,
                                                                                          timeout=timeout)))
    ...
    async def is_editable(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.is_editable", self._impl_obj.is_editable(selector=selector,
                                                                                          timeout=timeout)))
    ...
    async def is_enabled(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.is_enabled", self._impl_obj.is_enabled(selector=selector,
                                                                                        timeout=timeout)))
    ...
    async def is_hidden(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.is_hidden", self._impl_obj.is_hidden(selector=selector,
                                                                                      timeout=timeout)))
    ...
    async def is_visible(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.is_visible", self._impl_obj.is_visible(selector=selector,
                                                                                        timeout=timeout)))
    ...
    async def dispatch_event(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.dispatch_event", self._impl_obj.dispatch_event(selector=selector,
                                                                                                type=type,
                                                                                                eventInit=mapping.to_impl(event_init),
                                                                                                timeout=timeout)))
    ...
    async def eval_on_selector(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.eval_on_selector", self._impl_obj.eval_on_selector(selector=selector,
                                                                                                    expression=expression,
                                                                                                    arg=mapping.to_impl(arg))))
    ...
    async def eval_on_selector_all(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.eval_on_selector_all", self._impl_obj.eval_on_selector_all(selector=selector,
                                                                                                            expression=expression,
                                                                                                            arg=mapping.to_impl(arg))))
    ...
    async def content(self) -> str:
        ...
        return mapping.from_maybe_impl(await self._async("frame.content", self._impl_obj.content()))

    async def set_content(self,
                    html: str,
                    *,
                    timeout: float = None,
                    wait_until: Literal['domcontentloaded', 'load', 'networkidle'] = None) -> NoneType:
        """Frame.set_content
        ...
        return mapping.from_maybe_impl(await self._async("frame.set_content", self._impl_obj.set_content(html=html,
                                                                                          timeout=timeout,
                                                                                          waitUntil=wait_until)))
    ...
    async def add_script_tag(self,
        ...
        return mapping.from_impl(await self._async("frame.add_script_tag", self._impl_obj.add_script_tag(url=url,
                                                                                          path=path,
                                                                                          content=content,
                                                                                          type=type)))
    ...
    async def add_style_tag(self,
        ...
        return mapping.from_impl(await self._async("frame.add_style_tag", self._impl_obj.add_style_tag(url=url,
                                                                                        path=path,
                                                                                        content=content)))
    ...
    async def click(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.click", self._impl_obj.click(selector=selector,
                                                                              modifiers=modifiers,
                                                                              position=position,
                                                                              delay=delay,
                                                                              button=button,
    ...
    async def dblclick(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.dblclick", self._impl_obj.dblclick(selector=selector,
                                                                                    modifiers=modifiers,
                                                                                    position=position,
                                                                                    delay=delay,
                                                                                    button=button,
    ...
    async def tap(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.tap", self._impl_obj.tap(selector=selector,
                                                                          modifiers=modifiers,
                                                                          position=position,
                                                                          timeout=timeout,
                                                                          force=force,
    ...
    async def fill(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.fill", self._impl_obj.fill(selector=selector,
                                                                            value=value,
                                                                            timeout=timeout,
                                                                            noWaitAfter=no_wait_after)))
    ...
    async def focus(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.focus", self._impl_obj.focus(selector=selector,
                                                                              timeout=timeout)))

    async def text_content(self,
                     selector: str,
                     *,
                     timeout: float = None) -> typing.Optional[str]:
        """Frame.text_content
        ...
        return mapping.from_maybe_impl(await self._async("frame.text_content", self._impl_obj.text_content(selector=selector,
                                                                                            timeout=timeout)))
    ...
    async def inner_text(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.inner_text", self._impl_obj.inner_text(selector=selector,
                                                                                        timeout=timeout)))
    ...
    async def inner_html(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.inner_html", self._impl_obj.inner_html(selector=selector,
                                                                                        timeout=timeout)))
    ...
    async def get_attribute(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.get_attribute", self._impl_obj.get_attribute(selector=selector,
                                                                                              name=name,
                                                                                              timeout=timeout)))
    ...
    async def hover(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.hover", self._impl_obj.hover(selector=selector,
                                                                              modifiers=modifiers,
                                                                              position=position,
                                                                              timeout=timeout,
                                                                              force=force)))
    ...
    async def select_option(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.select_option", self._impl_obj.select_option(selector=selector,
                                                                                              value=value,
                                                                                              index=index,
                                                                                              label=label,
                                                                                              element=mapping.to_impl(element),
    ...
    async def set_input_files(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.set_input_files", self._impl_obj.set_input_files(selector=selector,
                                                                                                  files=files,
                                                                                                  timeout=timeout,
                                                                                                  noWaitAfter=no_wait_after)))
    ...
    async def type(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.type", self._impl_obj.type(selector=selector,
                                                                            text=text,
                                                                            delay=delay,
                                                                            timeout=timeout,
                                                                            noWaitAfter=no_wait_after)))
    ...
    async def press(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.press", self._impl_obj.press(selector=selector,
                                                                              key=key,
                                                                              delay=delay,
                                                                              timeout=timeout,
                                                                              noWaitAfter=no_wait_after)))
    ...
    async def check(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.check", self._impl_obj.check(selector=selector,
                                                                              timeout=timeout,
                                                                              force=force,
                                                                              noWaitAfter=no_wait_after)))
    ...
    async def uncheck(self,
        ...
        return mapping.from_maybe_impl(await self._async("frame.uncheck", self._impl_obj.uncheck(selector=selector,
                                                                                  timeout=timeout,
                                                                                  force=force,
                                                                                  noWaitAfter=no_wait_after)))

    async def wait_for_timeout(self,
                         timeout: float) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("frame.wait_for_timeout", self._impl_obj.wait_for_timeout(timeout=timeout)))
    ...
    async def wait_for_function(self,
                          ...
                          *,
                          arg: typing.Any = None,
                          timeout: float = None,
                          polling: typing.Union[float, Literal['raf']] = None) -> "JSHandle":
        ...
        return mapping.from_impl(await self._async("frame.wait_for_function", self._impl_obj.wait_for_function(expression=expression,
                                                                                                arg=mapping.to_impl(arg),
                                                                                                timeout=timeout,
                                                                                                polling=polling)))
    ...
    async def title(self) -> str:
        ...
        return mapping.from_maybe_impl(await self._async("frame.title", self._impl_obj.title()))
...
class Worker(AsyncBase):
    ...
    async def evaluate(self,
        ...
        return mapping.from_maybe_impl(await self._async("worker.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                                     arg=mapping.to_impl(arg))))
    ...
    async def evaluate_handle(self,
        ...
        return mapping.from_impl(await self._async("worker.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                             arg=mapping.to_impl(arg))))
...
class Selectors(AsyncBase):
    ...
    async def register(self,
                 ...
                 *,
                 path: typing.Union[str, pathlib.Path] = None,
                 content_script: bool = None) -> NoneType:
        """Selectors.register
        ...
        return mapping.from_maybe_impl(await self._async("selectors.register", self._impl_obj.register(name=name,
                                                                                        script=script,
                                                                                        path=path,
...
class Dialog(AsyncBase):
    ...
    async def accept(self,
        ...
        return mapping.from_maybe_impl(await self._async("dialog.accept", self._impl_obj.accept(promptText=prompt_text)))
    ...
    async def dismiss(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("dialog.dismiss", self._impl_obj.dismiss()))
...
class Download(AsyncBase):
    ...
    async def delete(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("download.delete", self._impl_obj.delete()))
    ...
    async def failure(self) -> typing.Optional[str]:
        ...
        return mapping.from_maybe_impl(await self._async("download.failure", self._impl_obj.failure()))
    ...
    async def path(self) -> typing.Optional[pathlib.Path]:
        ...
        return mapping.from_maybe_impl(await self._async("download.path", self._impl_obj.path()))
    ...
    async def save_as(self,
        ...
        return mapping.from_maybe_impl(await self._async("download.save_as", self._impl_obj.save_as(path=path)))
...
class Video(AsyncBase):
    ...
    async def path(self) -> pathlib.Path:
        ...
        return mapping.from_maybe_impl(await self._async("video.path", self._impl_obj.path()))
...
class Page(AsyncBase):
    ...
    async def opener(self) -> typing.Optional["Page"]:
        ...
        return mapping.from_impl_nullable(await self._async("page.opener", self._impl_obj.opener()))

    def frame(self,
              name: str = None,
              *,
              url: typing.Union[str, typing.Pattern, typing.Callable[[str], bool]] = None) -> typing.Optional["Frame"]:
        """Page.frame
        ...
        return mapping.from_impl_nullable(self._impl_obj.frame(name=name,
                                                url=self._wrap_handler(url)))

    def set_default_navigation_timeout(self,
                                       timeout: float) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._impl_obj.set_default_navigation_timeout(timeout=timeout))
    ...
    def set_default_timeout(self,
        ...
        return mapping.from_maybe_impl(self._impl_obj.set_default_timeout(timeout=timeout))
    ...
    async def query_selector(self,
        ...
        return mapping.from_impl_nullable(await self._async("page.query_selector", self._impl_obj.query_selector(selector=selector)))
    ...
    async def query_selector_all(self,
        ...
        return mapping.from_impl_list(await self._async("page.query_selector_all", self._impl_obj.query_selector_all(selector=selector)))
    ...
    async def wait_for_selector(self,
        ...
        return mapping.from_impl_nullable(await self._async("page.wait_for_selector", self._impl_obj.wait_for_selector(selector=selector,
                                                                                                        timeout=timeout,
                                                                                                        state=state)))
    ...
    async def is_checked(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.is_checked", self._impl_obj.is_checked(selector=selector,
                                                                                       timeout=timeout)))
    ...
    async def is_disabled(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.is_disabled", self._impl_obj.is_disabled(selector=selector,
                                                                                         timeout=timeout)))
    ...
    async def is_editable(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.is_editable", self._impl_obj.is_editable(selector=selector,
                                                                                         timeout=timeout)))
    ...
    async def is_enabled(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.is_enabled", self._impl_obj.is_enabled(selector=selector,
                                                                                       timeout=timeout)))
    ...
    async def is_hidden(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.is_hidden", self._impl_obj.is_hidden(selector=selector,
                                                                                     timeout=timeout)))
    ...
    async def is_visible(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.is_visible", self._impl_obj.is_visible(selector=selector,
                                                                                       timeout=timeout)))
    ...
    async def dispatch_event(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.dispatch_event", self._impl_obj.dispatch_event(selector=selector,
                                                                                               type=type,
                                                                                               eventInit=mapping.to_impl(event_init),
                                                                                               timeout=timeout)))
    ...
    async def evaluate(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                                   arg=mapping.to_impl(arg))))
    ...
    async def evaluate_handle(self,
        ...
        return mapping.from_impl(await self._async("page.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                           arg=mapping.to_impl(arg))))
    ...
    async def eval_on_selector(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.eval_on_selector", self._impl_obj.eval_on_selector(selector=selector,
                                                                                                   expression=expression,
                                                                                                   arg=mapping.to_impl(arg))))
    ...
    async def eval_on_selector_all(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.eval_on_selector_all", self._impl_obj.eval_on_selector_all(selector=selector,
                                                                                                           expression=expression,
                                                                                                           arg=mapping.to_impl(arg))))
    ...
    async def add_script_tag(self,
        ...
        return mapping.from_impl(await self._async("page.add_script_tag", self._impl_obj.add_script_tag(url=url,
                                                                                         path=path,
                                                                                         content=content,
                                                                                         type=type)))
    ...
    async def add_style_tag(self,
        ...
        return mapping.from_impl(await self._async("page.add_style_tag", self._impl_obj.add_style_tag(url=url,
                                                                                       path=path,
                                                                                       content=content)))

    async def expose_function(self,
                        name: str,
                        callback: typing.Callable) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("page.expose_function", self._impl_obj.expose_function(name=name,
                                                                                                 callback=self._wrap_handler(callback))))

    async def expose_binding(self,
                       name: str,
                       callback: typing.Callable,
                       *,
                       handle: bool = None) -> NoneType:
        """Page.expose_binding
        ...
        return mapping.from_maybe_impl(await self._async("page.expose_binding", self._impl_obj.expose_binding(name=name,
                                                                                               callback=self._wrap_handler(callback),
                                                                                               handle=handle)))

    async def set_extra_http_headers(self,
                               headers: typing.Dict[str, str]) -> NoneType:
        """Page.set_extra_http_headers
        ...
        return mapping.from_maybe_impl(await self._async("page.set_extra_http_headers", self._impl_obj.set_extra_http_headers(headers=mapping.to_impl(headers))))
    ...
    async def content(self) -> str:
        ...
        return mapping.from_maybe_impl(await self._async("page.content", self._impl_obj.content()))
    ...
    async def set_content(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.set_content", self._impl_obj.set_content(html=html,
                                                                                         timeout=timeout,
                                                                                         waitUntil=wait_until)))
    ...
    async def goto(self,
        ...
        return mapping.from_impl_nullable(await self._async("page.goto", self._impl_obj.goto(url=url,
                                                                              timeout=timeout,
                                                                              waitUntil=wait_until,
                                                                              referer=referer)))
    ...
    async def reload(self,
               *,
               timeout: float = None,
               wait_until: Literal['domcontentloaded', 'load', 'networkidle'] = None) -> typing.Optional["Response"]:
        """Page.reload
        ...
        return mapping.from_impl_nullable(await self._async("page.reload", self._impl_obj.reload(timeout=timeout,
                                                                                  waitUntil=wait_until)))
    ...
    async def wait_for_load_state(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.wait_for_load_state", self._impl_obj.wait_for_load_state(state=state,
                                                                                                         timeout=timeout)))
    ...
    async def wait_for_event(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.wait_for_event", self._impl_obj.wait_for_event(event=event,
                                                                                               predicate=self._wrap_handler(predicate),
                                                                                               timeout=timeout)))
    ...
    async def go_back(self,
        ...
        return mapping.from_impl_nullable(await self._async("page.go_back", self._impl_obj.go_back(timeout=timeout,
                                                                                    waitUntil=wait_until)))
    ...
    async def go_forward(self,
        ...
        return mapping.from_impl_nullable(await self._async("page.go_forward", self._impl_obj.go_forward(timeout=timeout,
                                                                                          waitUntil=wait_until)))

    async def emulate_media(self,
                      *,
                      media: Literal['print', 'screen'] = None,
                      color_scheme: Literal['dark', 'light', 'no-preference'] = None) -> NoneType:
        """Page.emulate_media
        ...
        return mapping.from_maybe_impl(await self._async("page.emulate_media", self._impl_obj.emulate_media(media=media,
                                                                                             colorScheme=color_scheme)))

    async def set_viewport_size(self,
                          viewport_size: ViewportSize) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("page.set_viewport_size", self._impl_obj.set_viewport_size(viewportSize=viewport_size)))
    ...
    async def bring_to_front(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("page.bring_to_front", self._impl_obj.bring_to_front()))

    async def add_init_script(self,
                        script: str = None,
                        *,
                        path: typing.Union[str, pathlib.Path] = None) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("page.add_init_script", self._impl_obj.add_init_script(script=script,
                                                                                                 path=path)))

    async def route(self,
              url: typing.Union[str, typing.Pattern, typing.Callable[[str], bool]],
              handler: typing.Union[typing.Callable[["Route"], typing.Any], typing.Callable[["Route", "Request"], typing.Any]]) -> NoneType:
        """Page.route
        ...
        return mapping.from_maybe_impl(await self._async("page.route", self._impl_obj.route(url=self._wrap_handler(url),
                                                                             handler=self._wrap_handler(handler))))

    async def unroute(self,
                url: typing.Union[str, typing.Pattern, typing.Callable[[str], bool]],
                handler: typing.Union[typing.Callable[["Route"], typing.Any], typing.Callable[["Route", "Request"], typing.Any]] = None) -> NoneType:
        """Page.unroute
        ...
        return mapping.from_maybe_impl(await self._async("page.unroute", self._impl_obj.unroute(url=self._wrap_handler(url),
                                                                                 handler=self._wrap_handler(handler))))
    ...
    async def screenshot(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.screenshot", self._impl_obj.screenshot(timeout=timeout,
                                                                                       type=type,
                                                                                       path=path,
                                                                                       quality=quality,
                                                                                       omitBackground=omit_background,
    ...
    async def title(self) -> str:
        ...
        return mapping.from_maybe_impl(await self._async("page.title", self._impl_obj.title()))

    async def close(self,
              *,
              run_before_unload: bool = None) -> NoneType:
        """Page.close
        ...
        return mapping.from_maybe_impl(await self._async("page.close", self._impl_obj.close(runBeforeUnload=run_before_unload)))
    ...
    async def click(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.click", self._impl_obj.click(selector=selector,
                                                                             modifiers=modifiers,
                                                                             position=position,
                                                                             delay=delay,
                                                                             button=button,
    ...
    async def dblclick(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.dblclick", self._impl_obj.dblclick(selector=selector,
                                                                                   modifiers=modifiers,
                                                                                   position=position,
                                                                                   delay=delay,
                                                                                   button=button,
    ...
    async def tap(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.tap", self._impl_obj.tap(selector=selector,
                                                                         modifiers=modifiers,
                                                                         position=position,
                                                                         timeout=timeout,
                                                                         force=force,
    ...
    async def fill(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.fill", self._impl_obj.fill(selector=selector,
                                                                           value=value,
                                                                           timeout=timeout,
                                                                           noWaitAfter=no_wait_after)))
    ...
    async def focus(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.focus", self._impl_obj.focus(selector=selector,
                                                                             timeout=timeout)))
    ...
    async def text_content(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.text_content", self._impl_obj.text_content(selector=selector,
                                                                                           timeout=timeout)))
    ...
    async def inner_text(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.inner_text", self._impl_obj.inner_text(selector=selector,
                                                                                       timeout=timeout)))
    ...
    async def inner_html(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.inner_html", self._impl_obj.inner_html(selector=selector,
                                                                                       timeout=timeout)))
    ...
    async def get_attribute(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.get_attribute", self._impl_obj.get_attribute(selector=selector,
                                                                                             name=name,
                                                                                             timeout=timeout)))
    ...
    async def hover(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.hover", self._impl_obj.hover(selector=selector,
                                                                             modifiers=modifiers,
                                                                             position=position,
                                                                             timeout=timeout,
                                                                             force=force)))
    ...
    async def select_option(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.select_option", self._impl_obj.select_option(selector=selector,
                                                                                             value=value,
                                                                                             index=index,
                                                                                             label=label,
                                                                                             element=mapping.to_impl(element),
    ...
    async def set_input_files(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.set_input_files", self._impl_obj.set_input_files(selector=selector,
                                                                                                 files=files,
                                                                                                 timeout=timeout,
                                                                                                 noWaitAfter=no_wait_after)))
    ...
    async def type(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.type", self._impl_obj.type(selector=selector,
                                                                           text=text,
                                                                           delay=delay,
                                                                           timeout=timeout,
                                                                           noWaitAfter=no_wait_after)))
    ...
    async def press(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.press", self._impl_obj.press(selector=selector,
                                                                             key=key,
                                                                             delay=delay,
                                                                             timeout=timeout,
                                                                             noWaitAfter=no_wait_after)))
    ...
    async def check(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.check", self._impl_obj.check(selector=selector,
                                                                             timeout=timeout,
                                                                             force=force,
                                                                             noWaitAfter=no_wait_after)))
    ...
    async def uncheck(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.uncheck", self._impl_obj.uncheck(selector=selector,
                                                                                 timeout=timeout,
                                                                                 force=force,
                                                                                 noWaitAfter=no_wait_after)))
    ...
    async def wait_for_timeout(self,
        ...
        return mapping.from_maybe_impl(await self._async("page.wait_for_timeout", self._impl_obj.wait_for_timeout(timeout=timeout)))
    ...
    async def wait_for_function(self,
        ...
        return mapping.from_impl(await self._async("page.wait_for_function", self._impl_obj.wait_for_function(expression=expression,
                                                                                               arg=mapping.to_impl(arg),
                                                                                               timeout=timeout,
                                                                                               polling=polling)))
    ...
    async def pause(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("page.pause", self._impl_obj.pause()))
    ...
    async def pdf(self,
            *,
            ...
            path: typing.Union[str, pathlib.Path] = None) -> bytes:
        """Page.pdf
        ...
        return mapping.from_maybe_impl(await self._async("page.pdf", self._impl_obj.pdf(scale=scale,
    ...
    def expect_console_message(self,
                               ...
                               *,
                               timeout: float = None) -> AsyncEventContextManager["ConsoleMessage"]:
        ...
        return AsyncEventContextManager(self._impl_obj.expect_console_message(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_download(self,
                        predicate: typing.Optional[typing.Callable[["Download"], bool]] = None,
                        *,
                        timeout: float = None) -> AsyncEventContextManager["Download"]:
        ...
        return AsyncEventContextManager(self._impl_obj.expect_download(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_file_chooser(self,
                            predicate: typing.Optional[typing.Callable[["FileChooser"], bool]] = None,
                            *,
                            timeout: float = None) -> AsyncEventContextManager["FileChooser"]:
        ...
        return AsyncEventContextManager(self._impl_obj.expect_file_chooser(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)
    ...
    def expect_popup(self,
                     ...
                     *,
                     timeout: float = None) -> AsyncEventContextManager["Page"]:
        """Page.expect_popup
        ...
        return AsyncEventContextManager(self._impl_obj.expect_popup(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_request(self,
                       url_or_predicate: typing.Union[str, typing.Pattern, typing.Callable[["Request"], bool]],
                       *,
                       timeout: float = None) -> AsyncEventContextManager["Request"]:
        """Page.expect_request
        ...
        return AsyncEventContextManager(self._impl_obj.expect_request(url_or_predicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)

    def expect_response(self,
                        url_or_predicate: typing.Union[str, typing.Pattern, typing.Callable[["Response"], bool]],
                        *,
                        timeout: float = None) -> AsyncEventContextManager["Response"]:
        ...
        return AsyncEventContextManager(self._impl_obj.expect_response(url_or_predicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)

    def expect_worker(self,
                      predicate: typing.Optional[typing.Callable[["Worker"], bool]] = None,
                      *,
                      timeout: float = None) -> AsyncEventContextManager["Worker"]:
        """Page.expect_worker
        ...
        return AsyncEventContextManager(self._impl_obj.expect_worker(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)
...
class BrowserContext(AsyncBase):
    ...
    async def cookies(self,
                urls: typing.Union[str, typing.List[str]] = None) -> typing.List[Cookie]:
        ...
        return mapping.from_impl_list(await self._async("browser_context.cookies", self._impl_obj.cookies(urls=urls)))

    async def add_cookies(self,
                    cookies: typing.List[Cookie]) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.add_cookies", self._impl_obj.add_cookies(cookies=cookies)))
    ...
    async def clear_cookies(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.clear_cookies", self._impl_obj.clear_cookies()))

    async def grant_permissions(self,
                          permissions: typing.List[str],
                          *,
                          origin: str = None) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.grant_permissions", self._impl_obj.grant_permissions(permissions=permissions,
                                                                                                                origin=origin)))
    ...
    async def clear_permissions(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.clear_permissions", self._impl_obj.clear_permissions()))

    async def set_geolocation(self,
                        geolocation: Geolocation = None) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.set_geolocation", self._impl_obj.set_geolocation(geolocation=geolocation)))
    ...
    async def set_extra_http_headers(self,
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.set_extra_http_headers", self._impl_obj.set_extra_http_headers(headers=mapping.to_impl(headers))))

    async def set_offline(self,
                    offline: bool) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.set_offline", self._impl_obj.set_offline(offline=offline)))
    ...
    async def add_init_script(self,
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.add_init_script", self._impl_obj.add_init_script(script=script,
                                                                                                            path=path)))
    ...
    async def expose_binding(self,
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.expose_binding", self._impl_obj.expose_binding(name=name,
                                                                                                          callback=self._wrap_handler(callback),
                                                                                                          handle=handle)))
    ...
    async def expose_function(self,
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.expose_function", self._impl_obj.expose_function(name=name,
                                                                                                            callback=self._wrap_handler(callback))))
    ...
    async def route(self,
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.route", self._impl_obj.route(url=self._wrap_handler(url),
                                                                                        handler=self._wrap_handler(handler))))
    ...
    async def unroute(self,
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.unroute", self._impl_obj.unroute(url=self._wrap_handler(url),
                                                                                            handler=self._wrap_handler(handler))))
    ...
    async def close(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.close", self._impl_obj.close()))

    async def storage_state(self,
                      *,
                      path: typing.Union[str, pathlib.Path] = None) -> StorageState:
        ...
        return mapping.from_impl(await self._async("browser_context.storage_state", self._impl_obj.storage_state(path=path)))
    ...
    async def wait_for_event(self,
        ...
        return mapping.from_maybe_impl(await self._async("browser_context.wait_for_event", self._impl_obj.wait_for_event(event=event,
                                                                                                          predicate=self._wrap_handler(predicate),
                                                                                                          timeout=timeout)))
    ...
    def expect_page(self,
        ...
        return AsyncEventContextManager(self._impl_obj.expect_page(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)
...
class CDPSession(AsyncBase):
    ...
    async def send(self,
             method: str,
             params: typing.Dict = None) -> typing.Dict:
        """CDPSession.send
        ...
        return mapping.from_maybe_impl(await self._async("cdp_session.send", self._impl_obj.send(method=method,
    ...
    async def detach(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("cdp_session.detach", self._impl_obj.detach()))
...
class ChromiumBrowserContext(BrowserContext):
    ...
    async def new_cdp_session(self,
                        page: "Page") -> "CDPSession":
        ...
        return mapping.from_impl(await self._async("chromium_browser_context.new_cdp_session", self._impl_obj.new_cdp_session(page=page._impl_obj)))
...
class Browser(AsyncBase):
    ...
    async def new_context(self,
                    *,
                    ...
                    storage_state: typing.Union[StorageState, str, pathlib.Path] = None) -> "BrowserContext":
        """Browser.new_context
        ...
        return mapping.from_impl(await self._async("browser.new_context", self._impl_obj.new_context(viewport=viewport,
    ...
    async def new_page(self,
                 *,
                 ...
                 record_video_dir: typing.Union[str, pathlib.Path] = None,
                 record_video_size: ViewportSize = None,
                 storage_state: typing.Union[StorageState, str, pathlib.Path] = None) -> "Page":
        """Browser.new_page
        ...
        return mapping.from_impl(await self._async("browser.new_page", self._impl_obj.new_page(viewport=viewport,
                                                                                noViewport=no_viewport,
                                                                                ignoreHTTPSErrors=ignore_https_errors,
                                                                                javaScriptEnabled=java_script_enabled,
                                                                                bypassCSP=bypass_csp,
    ...
    async def close(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(await self._async("browser.close", self._impl_obj.close()))
...
class BrowserType(AsyncBase):
    ...
    async def launch(self,
               *,
               ...
               firefox_user_prefs: typing.Optional[typing.Dict[str, typing.Union[str, float, bool]]] = None) -> "Browser":
        """BrowserType.launch
        ...
        return mapping.from_impl(await self._async("browser_type.launch", self._impl_obj.launch(executablePath=executable_path,
                                                                                 args=args,
    ...
    async def launch_persistent_context(self,
                                  ...
                                  *,
                                  ...
                                  record_har_omit_content: bool = None,
                                  record_video_dir: typing.Union[str, pathlib.Path] = None,
                                  record_video_size: ViewportSize = None) -> "BrowserContext":
        ...
        return mapping.from_impl(await self._async("browser_type.launch_persistent_context", self._impl_obj.launch_persistent_context(userDataDir=user_data_dir,
