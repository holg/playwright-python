...
class Request(SyncBase):
    ...
    def response(self) -> typing.Optional["Response"]:
        ...
        return mapping.from_impl_nullable(self._sync("request.response", self._impl_obj.response()))
...
class Response(SyncBase):
    ...
    def finished(self) -> typing.Optional[str]:
        ...
        return mapping.from_maybe_impl(self._sync("response.finished", self._impl_obj.finished()))
    ...
    def body(self) -> bytes:
        ...
        return mapping.from_maybe_impl(self._sync("response.body", self._impl_obj.body()))
    ...
    def text(self) -> str:
        ...
        return mapping.from_maybe_impl(self._sync("response.text", self._impl_obj.text()))
    ...
    def json(self) -> typing.Any:
        ...
        return mapping.from_maybe_impl(self._sync("response.json", self._impl_obj.json()))
...
class Route(SyncBase):
    ...
    def abort(self,
        ...
        return mapping.from_maybe_impl(self._sync("route.abort", self._impl_obj.abort(errorCode=error_code)))
    ...
    def fulfill(self,
        ...
        return mapping.from_maybe_impl(self._sync("route.fulfill", self._impl_obj.fulfill(status=status,
    ...
    def continue_(self,
        ...
        return mapping.from_maybe_impl(self._sync("route.continue_", self._impl_obj.continue_(url=url,
                                                                               method=method,
                                                                               headers=mapping.to_impl(headers),
                                                                               postData=post_data)))
...
class WebSocket(SyncBase):
    ...
    def expect_event(self,
                     ...
                     *,
                     timeout: float = None) -> EventContextManager:
        ...
        EventContextManager
        """
        return EventContextManager(self, self._impl_obj.expect_event(event=event,
    ...
    def wait_for_event(self,
        ...
        return mapping.from_maybe_impl(self._sync("web_socket.wait_for_event", self._impl_obj.wait_for_event(event=event,
                                                                                              predicate=self._wrap_handler(predicate),
                                                                                              timeout=timeout)))
...
class Keyboard(SyncBase):
    ...
    def down(self,
        ...
        return mapping.from_maybe_impl(self._sync("keyboard.down", self._impl_obj.down(key=key)))
    ...
    def up(self,
        ...
        return mapping.from_maybe_impl(self._sync("keyboard.up", self._impl_obj.up(key=key)))
    ...
    def insert_text(self,
        ...
        return mapping.from_maybe_impl(self._sync("keyboard.insert_text", self._impl_obj.insert_text(text=text)))
    ...
    def type(self,
        ...
        return mapping.from_maybe_impl(self._sync("keyboard.type", self._impl_obj.type(text=text,
                                                                        delay=delay)))
    ...
    def press(self,
        ...
        return mapping.from_maybe_impl(self._sync("keyboard.press", self._impl_obj.press(key=key,
                                                                          delay=delay)))
...
class Mouse(SyncBase):
    ...
    def move(self,
        ...
        return mapping.from_maybe_impl(self._sync("mouse.move", self._impl_obj.move(x=x,
                                                                     y=y,
                                                                     steps=steps)))
    ...
    def down(self,
        ...
        return mapping.from_maybe_impl(self._sync("mouse.down", self._impl_obj.down(button=button,
    ...
    def up(self,
        ...
        return mapping.from_maybe_impl(self._sync("mouse.up", self._impl_obj.up(button=button,
                                                                 clickCount=click_count)))
    ...
    def click(self,
        ...
        return mapping.from_maybe_impl(self._sync("mouse.click", self._impl_obj.click(x=x,
                                                                       y=y,
                                                                       delay=delay,
                                                                       button=button,
                                                                       clickCount=click_count)))
    ...
    def dblclick(self,
        ...
        return mapping.from_maybe_impl(self._sync("mouse.dblclick", self._impl_obj.dblclick(x=x,
                                                                             y=y,
                                                                             delay=delay,
                                                                             button=button)))
...
class Touchscreen(SyncBase):
    ...
    def tap(self,
        ...
        return mapping.from_maybe_impl(self._sync("touchscreen.tap", self._impl_obj.tap(x=x,
                                                                         y=y)))
...
class JSHandle(SyncBase):
    ...
    def evaluate(self,
        ...
        return mapping.from_maybe_impl(self._sync("js_handle.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                                 arg=mapping.to_impl(arg))))

    def evaluate_handle(self,
                        expression: str,
        ...
        return mapping.from_impl(self._sync("js_handle.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                         arg=mapping.to_impl(arg))))
    ...
    def get_property(self,
        ...
        return mapping.from_impl(self._sync("js_handle.get_property", self._impl_obj.get_property(propertyName=property_name)))
    ...
    def get_properties(self) -> typing.Dict[str, "JSHandle"]:
        ...
        return mapping.from_impl_dict(self._sync("js_handle.get_properties", self._impl_obj.get_properties()))
    ...
    def dispose(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("js_handle.dispose", self._impl_obj.dispose()))
    ...
    def json_value(self) -> typing.Any:
        ...
        return mapping.from_maybe_impl(self._sync("js_handle.json_value", self._impl_obj.json_value()))
...
class ElementHandle(JSHandle):
    ...
    def owner_frame(self) -> typing.Optional["Frame"]:
        ...
        return mapping.from_impl_nullable(self._sync("element_handle.owner_frame", self._impl_obj.owner_frame()))
    ...
    def content_frame(self) -> typing.Optional["Frame"]:
        ...
        return mapping.from_impl_nullable(self._sync("element_handle.content_frame", self._impl_obj.content_frame()))
    ...
    def get_attribute(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.get_attribute", self._impl_obj.get_attribute(name=name)))
    ...
    def text_content(self) -> typing.Optional[str]:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.text_content", self._impl_obj.text_content()))
    ...
    def inner_text(self) -> str:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.inner_text", self._impl_obj.inner_text()))
    ...
    def is_checked(self) -> bool:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.is_checked", self._impl_obj.is_checked()))
    ...
    def is_disabled(self) -> bool:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.is_disabled", self._impl_obj.is_disabled()))
    ...
    def is_enabled(self) -> bool:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.is_enabled", self._impl_obj.is_enabled()))
    ...
    def is_hidden(self) -> bool:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.is_hidden", self._impl_obj.is_hidden()))
    ...
    def is_visible(self) -> bool:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.is_visible", self._impl_obj.is_visible()))
    ...
    def dispatch_event(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.dispatch_event", self._impl_obj.dispatch_event(type=type,
    ...
    def scroll_into_view_if_needed(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.scroll_into_view_if_needed", self._impl_obj.scroll_into_view_if_needed(timeout=timeout)))
    ...
    def hover(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.hover", self._impl_obj.hover(modifiers=modifiers,
                                                                                position=position,
                                                                                timeout=timeout,
                                                                                force=force)))
    ...
    def click(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.click", self._impl_obj.click(modifiers=modifiers,
                                                                                position=position,
                                                                                delay=delay,
                                                                                button=button,
                                                                                clickCount=click_count,
    ...
    def dblclick(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.dblclick", self._impl_obj.dblclick(modifiers=modifiers,
                                                                                      position=position,
                                                                                      delay=delay,
                                                                                      button=button,
                                                                                      timeout=timeout,
    ...
    def select_option(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.select_option", self._impl_obj.select_option(value=value,
                                                                                                index=index,
                                                                                                label=label,
    ...
    def tap(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.tap", self._impl_obj.tap(modifiers=modifiers,
                                                                            position=position,
                                                                            timeout=timeout,
                                                                            force=force,
                                                                            noWaitAfter=no_wait_after)))
    ...
    def fill(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.fill", self._impl_obj.fill(value=value,
                                                                              timeout=timeout,
                                                                              noWaitAfter=no_wait_after)))
    ...
    def select_text(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.select_text", self._impl_obj.select_text(timeout=timeout)))
    ...
    def set_input_files(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.set_input_files", self._impl_obj.set_input_files(files=files,
                                                                                                    timeout=timeout,
                                                                                                    noWaitAfter=no_wait_after)))
    ...
    def focus(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.focus", self._impl_obj.focus()))
    ...
    def type(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.type", self._impl_obj.type(text=text,
                                                                              delay=delay,
                                                                              timeout=timeout,
                                                                              noWaitAfter=no_wait_after)))
    ...
    def press(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.press", self._impl_obj.press(key=key,
                                                                                delay=delay,
                                                                                timeout=timeout,
                                                                                noWaitAfter=no_wait_after)))
    ...
    def check(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.check", self._impl_obj.check(timeout=timeout,
                                                                                force=force,
                                                                                noWaitAfter=no_wait_after)))
    ...
    def uncheck(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.uncheck", self._impl_obj.uncheck(timeout=timeout,
                                                                                    force=force,
                                                                                    noWaitAfter=no_wait_after)))
    ...
    def bounding_box(self) -> typing.Optional[FloatRect]:
        ...
        return mapping.from_impl_nullable(self._sync("element_handle.bounding_box", self._impl_obj.bounding_box()))
    ...
    def screenshot(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.screenshot", self._impl_obj.screenshot(timeout=timeout,
                                                                                          type=type,
                                                                                          path=path,
                                                                                          quality=quality,
    ...
    def query_selector(self,
        ...
        return mapping.from_impl_nullable(self._sync("element_handle.query_selector", self._impl_obj.query_selector(selector=selector)))
    ...
    def query_selector_all(self,
        ...
        return mapping.from_impl_list(self._sync("element_handle.query_selector_all", self._impl_obj.query_selector_all(selector=selector)))

    def eval_on_selector(self,
                         selector: str,
                         expression: str,
                         arg: typing.Any = None) -> typing.Any:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.eval_on_selector", self._impl_obj.eval_on_selector(selector=selector,
                                                                                                      expression=expression,
                                                                                                      arg=mapping.to_impl(arg))))

    def eval_on_selector_all(self,
                             selector: str,
                             expression: str,
                             arg: typing.Any = None) -> typing.Any:
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.eval_on_selector_all", self._impl_obj.eval_on_selector_all(selector=selector,
                                                                                                              expression=expression,
                                                                                                              arg=mapping.to_impl(arg))))

    def wait_for_element_state(self,
        ...
        return mapping.from_maybe_impl(self._sync("element_handle.wait_for_element_state", self._impl_obj.wait_for_element_state(state=state,
                                                                                                                  timeout=timeout)))
    ...
    def wait_for_selector(self,
        ...
        return mapping.from_impl_nullable(self._sync("element_handle.wait_for_selector", self._impl_obj.wait_for_selector(selector=selector,
                                                                                                           state=state,
                                                                                                           timeout=timeout)))
...
class Accessibility(SyncBase):
    ...
    def snapshot(self,
        ...
        return mapping.from_maybe_impl(self._sync("accessibility.snapshot", self._impl_obj.snapshot(interestingOnly=interesting_only,
...
class FileChooser(SyncBase):
    ...
    def set_files(self,
        ...
        return mapping.from_maybe_impl(self._sync("file_chooser.set_files", self._impl_obj.set_files(files=files,
                                                                                      timeout=timeout,
                                                                                      noWaitAfter=no_wait_after)))
...
class Frame(SyncBase):
    ...
    def goto(self,
        ...
        return mapping.from_impl_nullable(self._sync("frame.goto", self._impl_obj.goto(url=url,
                                                                        timeout=timeout,
    ...
    def expect_navigation(self,
                          *,
                          ...
                          wait_until: Literal['domcontentloaded', 'load', 'networkidle'] = None,
                          timeout: float = None) -> EventContextManager["Response"]:
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_navigation(url=self._wrap_handler(url),
    ...
    def wait_for_load_state(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.wait_for_load_state", self._impl_obj.wait_for_load_state(state=state,
                                                                                                   timeout=timeout)))
    ...
    def frame_element(self) -> "ElementHandle":
        ...
        return mapping.from_impl(self._sync("frame.frame_element", self._impl_obj.frame_element()))
    ...
    def evaluate(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                             arg=mapping.to_impl(arg))))
    ...
    def evaluate_handle(self,
        ...
        return mapping.from_impl(self._sync("frame.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                     arg=mapping.to_impl(arg))))
    ...
    def query_selector(self,
        ...
        return mapping.from_impl_nullable(self._sync("frame.query_selector", self._impl_obj.query_selector(selector=selector)))
    ...
    def query_selector_all(self,
        ...
        return mapping.from_impl_list(self._sync("frame.query_selector_all", self._impl_obj.query_selector_all(selector=selector)))
    ...
    def wait_for_selector(self,
        ...
        return mapping.from_impl_nullable(self._sync("frame.wait_for_selector", self._impl_obj.wait_for_selector(selector=selector,
                                                                                                  timeout=timeout,
                                                                                                  state=state)))
    ...
    def is_checked(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.is_checked", self._impl_obj.is_checked(selector=selector,
                                                                                 timeout=timeout)))
    ...
    def is_disabled(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.is_disabled", self._impl_obj.is_disabled(selector=selector,
                                                                                   timeout=timeout)))
    ...
    def is_editable(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.is_editable", self._impl_obj.is_editable(selector=selector,
                                                                                   timeout=timeout)))
    ...
    def is_enabled(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.is_enabled", self._impl_obj.is_enabled(selector=selector,
                                                                                 timeout=timeout)))
    ...
    def is_hidden(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.is_hidden", self._impl_obj.is_hidden(selector=selector,
                                                                               timeout=timeout)))
    ...
    def is_visible(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.is_visible", self._impl_obj.is_visible(selector=selector,
                                                                                 timeout=timeout)))
    ...
    def dispatch_event(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.dispatch_event", self._impl_obj.dispatch_event(selector=selector,
                                                                                         type=type,
                                                                                         eventInit=mapping.to_impl(event_init),
                                                                                         timeout=timeout)))
    ...
    def eval_on_selector(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.eval_on_selector", self._impl_obj.eval_on_selector(selector=selector,
                                                                                             expression=expression,
                                                                                             arg=mapping.to_impl(arg))))
    ...
    def eval_on_selector_all(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.eval_on_selector_all", self._impl_obj.eval_on_selector_all(selector=selector,
                                                                                                     expression=expression,
                                                                                                     arg=mapping.to_impl(arg))))
    ...
    def content(self) -> str:
        ...
        return mapping.from_maybe_impl(self._sync("frame.content", self._impl_obj.content()))
    ...
    def set_content(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.set_content", self._impl_obj.set_content(html=html,
                                                                                   timeout=timeout,
                                                                                   waitUntil=wait_until)))
    ...
    def add_script_tag(self,
        ...
        return mapping.from_impl(self._sync("frame.add_script_tag", self._impl_obj.add_script_tag(url=url,
                                                                                   path=path,
                                                                                   content=content,
                                                                                   type=type)))

    def add_style_tag(self,
                      *,
                      url: str = None,
                      path: typing.Union[str, pathlib.Path] = None,
        ...
        return mapping.from_impl(self._sync("frame.add_style_tag", self._impl_obj.add_style_tag(url=url,
                                                                                 path=path,
                                                                                 content=content)))
    ...
    def click(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.click", self._impl_obj.click(selector=selector,
                                                                       modifiers=modifiers,
                                                                       position=position,
                                                                       delay=delay,
                                                                       button=button,
    ...
    def dblclick(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.dblclick", self._impl_obj.dblclick(selector=selector,
                                                                             modifiers=modifiers,
                                                                             position=position,
                                                                             delay=delay,
                                                                             button=button,
    ...
    def tap(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.tap", self._impl_obj.tap(selector=selector,
                                                                   modifiers=modifiers,
                                                                   position=position,
                                                                   timeout=timeout,
                                                                   force=force,
    ...
    def fill(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.fill", self._impl_obj.fill(selector=selector,
                                                                     value=value,
                                                                     timeout=timeout,
                                                                     noWaitAfter=no_wait_after)))
    ...
    def focus(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.focus", self._impl_obj.focus(selector=selector,
                                                                       timeout=timeout)))
    ...
    def text_content(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.text_content", self._impl_obj.text_content(selector=selector,
                                                                                     timeout=timeout)))
    ...
    def inner_text(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.inner_text", self._impl_obj.inner_text(selector=selector,
                                                                                 timeout=timeout)))
    ...
    def inner_html(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.inner_html", self._impl_obj.inner_html(selector=selector,
                                                                                 timeout=timeout)))
    ...
    def get_attribute(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.get_attribute", self._impl_obj.get_attribute(selector=selector,
                                                                                       name=name,
                                                                                       timeout=timeout)))
    ...
    def hover(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.hover", self._impl_obj.hover(selector=selector,
                                                                       modifiers=modifiers,
                                                                       position=position,
                                                                       timeout=timeout,
                                                                       force=force)))
    ...
    def select_option(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.select_option", self._impl_obj.select_option(selector=selector,
                                                                                       value=value,
                                                                                       index=index,
                                                                                       label=label,
                                                                                       element=mapping.to_impl(element),
    ...
    def set_input_files(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.set_input_files", self._impl_obj.set_input_files(selector=selector,
                                                                                           files=files,
                                                                                           timeout=timeout,
                                                                                           noWaitAfter=no_wait_after)))
    ...
    def type(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.type", self._impl_obj.type(selector=selector,
                                                                     text=text,
                                                                     delay=delay,
                                                                     timeout=timeout,
                                                                     noWaitAfter=no_wait_after)))
    ...
    def press(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.press", self._impl_obj.press(selector=selector,
                                                                       key=key,
                                                                       delay=delay,
                                                                       timeout=timeout,
                                                                       noWaitAfter=no_wait_after)))
    ...
    def check(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.check", self._impl_obj.check(selector=selector,
                                                                       timeout=timeout,
                                                                       force=force,
                                                                       noWaitAfter=no_wait_after)))
    ...
    def uncheck(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.uncheck", self._impl_obj.uncheck(selector=selector,
                                                                           timeout=timeout,
                                                                           force=force,
                                                                           noWaitAfter=no_wait_after)))
    ...
    def wait_for_timeout(self,
        ...
        return mapping.from_maybe_impl(self._sync("frame.wait_for_timeout", self._impl_obj.wait_for_timeout(timeout=timeout)))

    def wait_for_function(self,
                          expression: str,
                          *,
                          arg: typing.Any = None,
                          timeout: float = None,
        ...
        return mapping.from_impl(self._sync("frame.wait_for_function", self._impl_obj.wait_for_function(expression=expression,
                                                                                         arg=mapping.to_impl(arg),
                                                                                         timeout=timeout,
                                                                                         polling=polling)))
    ...
    def title(self) -> str:
        ...
        return mapping.from_maybe_impl(self._sync("frame.title", self._impl_obj.title()))
...
class Worker(SyncBase):
    ...
    def evaluate(self,
        ...
        return mapping.from_maybe_impl(self._sync("worker.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                              arg=mapping.to_impl(arg))))
    ...
    def evaluate_handle(self,
        ...
        return mapping.from_impl(self._sync("worker.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                      arg=mapping.to_impl(arg))))
...
class Selectors(SyncBase):
    ...
    def register(self,
        ...
        return mapping.from_maybe_impl(self._sync("selectors.register", self._impl_obj.register(name=name,
                                                                                 script=script,
                                                                                 path=path,
...
class Dialog(SyncBase):
    ...
    def accept(self,
        ...
        return mapping.from_maybe_impl(self._sync("dialog.accept", self._impl_obj.accept(promptText=prompt_text)))
    ...
    def dismiss(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("dialog.dismiss", self._impl_obj.dismiss()))
...
class Download(SyncBase):
    ...
    def delete(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("download.delete", self._impl_obj.delete()))
    ...
    def failure(self) -> typing.Optional[str]:
        ...
        return mapping.from_maybe_impl(self._sync("download.failure", self._impl_obj.failure()))
    ...
    def path(self) -> typing.Optional[pathlib.Path]:
        ...
        return mapping.from_maybe_impl(self._sync("download.path", self._impl_obj.path()))
    ...
    def save_as(self,
        ...
        return mapping.from_maybe_impl(self._sync("download.save_as", self._impl_obj.save_as(path=path)))
...
class Page(SyncBase):
    ...
    def opener(self) -> typing.Optional["Page"]:
        ...
        return mapping.from_impl_nullable(self._sync("page.opener", self._impl_obj.opener()))
    ...
    def query_selector(self,
        ...
        return mapping.from_impl_nullable(self._sync("page.query_selector", self._impl_obj.query_selector(selector=selector)))
    ...
    def query_selector_all(self,
        ...
        return mapping.from_impl_list(self._sync("page.query_selector_all", self._impl_obj.query_selector_all(selector=selector)))
    ...
    def wait_for_selector(self,
        ...
        return mapping.from_impl_nullable(self._sync("page.wait_for_selector", self._impl_obj.wait_for_selector(selector=selector,
                                                                                                 timeout=timeout,
                                                                                                 state=state)))
    ...
    def is_checked(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.is_checked", self._impl_obj.is_checked(selector=selector,
                                                                                timeout=timeout)))
    ...
    def is_disabled(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.is_disabled", self._impl_obj.is_disabled(selector=selector,
                                                                                  timeout=timeout)))
    ...
    def is_editable(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.is_editable", self._impl_obj.is_editable(selector=selector,
                                                                                  timeout=timeout)))
    ...
    def is_enabled(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.is_enabled", self._impl_obj.is_enabled(selector=selector,
                                                                                timeout=timeout)))
    ...
    def is_hidden(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.is_hidden", self._impl_obj.is_hidden(selector=selector,
                                                                              timeout=timeout)))
    ...
    def is_visible(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.is_visible", self._impl_obj.is_visible(selector=selector,
                                                                                timeout=timeout)))
    ...
    def dispatch_event(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.dispatch_event", self._impl_obj.dispatch_event(selector=selector,
                                                                                        type=type,
                                                                                        eventInit=mapping.to_impl(event_init),
                                                                                        timeout=timeout)))
    ...
    def evaluate(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.evaluate", self._impl_obj.evaluate(expression=expression,
                                                                            arg=mapping.to_impl(arg))))
    ...
    def evaluate_handle(self,
        ...
        return mapping.from_impl(self._sync("page.evaluate_handle", self._impl_obj.evaluate_handle(expression=expression,
                                                                                    arg=mapping.to_impl(arg))))
    ...
    def eval_on_selector(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.eval_on_selector", self._impl_obj.eval_on_selector(selector=selector,
                                                                                            expression=expression,
                                                                                            arg=mapping.to_impl(arg))))
    ...
    def eval_on_selector_all(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.eval_on_selector_all", self._impl_obj.eval_on_selector_all(selector=selector,
                                                                                                    expression=expression,
                                                                                                    arg=mapping.to_impl(arg))))
    ...
    def add_script_tag(self,
        ...
        return mapping.from_impl(self._sync("page.add_script_tag", self._impl_obj.add_script_tag(url=url,
                                                                                  path=path,
                                                                                  content=content,
                                                                                  type=type)))
    ...
    def add_style_tag(self,
        ...
        return mapping.from_impl(self._sync("page.add_style_tag", self._impl_obj.add_style_tag(url=url,
                                                                                path=path,
                                                                                content=content)))

    def expose_function(self,
                        name: str,
        ...
        return mapping.from_maybe_impl(self._sync("page.expose_function", self._impl_obj.expose_function(name=name,
                                                                                          callback=self._wrap_handler(callback))))

    def expose_binding(self,
                       name: str,
        ...
        return mapping.from_maybe_impl(self._sync("page.expose_binding", self._impl_obj.expose_binding(name=name,
                                                                                        callback=self._wrap_handler(callback),
                                                                                        handle=handle)))
    ...
    def set_extra_http_headers(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.set_extra_http_headers", self._impl_obj.set_extra_http_headers(headers=mapping.to_impl(headers))))
    ...
    def content(self) -> str:
        ...
        return mapping.from_maybe_impl(self._sync("page.content", self._impl_obj.content()))
    ...
    def set_content(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.set_content", self._impl_obj.set_content(html=html,
                                                                                  timeout=timeout,
                                                                                  waitUntil=wait_until)))
    ...
    def goto(self,
        ...
        return mapping.from_impl_nullable(self._sync("page.goto", self._impl_obj.goto(url=url,
                                                                       timeout=timeout,
                                                                       waitUntil=wait_until,
                                                                       referer=referer)))
    ...
    def reload(self,
        ...
        return mapping.from_impl_nullable(self._sync("page.reload", self._impl_obj.reload(timeout=timeout,
                                                                           waitUntil=wait_until)))
    ...
    def wait_for_load_state(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.wait_for_load_state", self._impl_obj.wait_for_load_state(state=state,
                                                                                                  timeout=timeout)))
    ...
    def wait_for_event(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.wait_for_event", self._impl_obj.wait_for_event(event=event,
                                                                                        predicate=self._wrap_handler(predicate),
                                                                                        timeout=timeout)))
    ...
    def go_back(self,
        ...
        return mapping.from_impl_nullable(self._sync("page.go_back", self._impl_obj.go_back(timeout=timeout,
                                                                             waitUntil=wait_until)))
    ...
    def go_forward(self,
        ...
        return mapping.from_impl_nullable(self._sync("page.go_forward", self._impl_obj.go_forward(timeout=timeout,
                                                                                   waitUntil=wait_until)))
    ...
    def emulate_media(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.emulate_media", self._impl_obj.emulate_media(media=media,
    ...
    def set_viewport_size(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.set_viewport_size", self._impl_obj.set_viewport_size(viewportSize=viewport_size)))
    ...
    def bring_to_front(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("page.bring_to_front", self._impl_obj.bring_to_front()))
    ...
    def add_init_script(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.add_init_script", self._impl_obj.add_init_script(script=script,
                                                                                          path=path)))
    ...
    def route(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.route", self._impl_obj.route(url=self._wrap_handler(url),
    ...
    def unroute(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.unroute", self._impl_obj.unroute(url=self._wrap_handler(url),
                                                                          handler=self._wrap_handler(handler))))
    ...
    def screenshot(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.screenshot", self._impl_obj.screenshot(timeout=timeout,
                                                                                type=type,
                                                                                path=path,
                                                                                quality=quality,
                                                                                omitBackground=omit_background,
    ...
    def close(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.close", self._impl_obj.close(runBeforeUnload=run_before_unload)))
    ...
    def click(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.click", self._impl_obj.click(selector=selector,
                                                                      modifiers=modifiers,
                                                                      position=position,
                                                                      delay=delay,
                                                                      button=button,
    ...
    def dblclick(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.dblclick", self._impl_obj.dblclick(selector=selector,
                                                                            modifiers=modifiers,
                                                                            position=position,
                                                                            delay=delay,
                                                                            button=button,
    ...
    def tap(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.tap", self._impl_obj.tap(selector=selector,
                                                                  modifiers=modifiers,
                                                                  position=position,
                                                                  timeout=timeout,
                                                                  force=force,
    ...
    def fill(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.fill", self._impl_obj.fill(selector=selector,
                                                                    value=value,
                                                                    timeout=timeout,
                                                                    noWaitAfter=no_wait_after)))
    ...
    def focus(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.focus", self._impl_obj.focus(selector=selector,
                                                                      timeout=timeout)))
    ...
    def text_content(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.text_content", self._impl_obj.text_content(selector=selector,
                                                                                    timeout=timeout)))
    ...
    def inner_text(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.inner_text", self._impl_obj.inner_text(selector=selector,
                                                                                timeout=timeout)))
    ...
    def inner_html(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.inner_html", self._impl_obj.inner_html(selector=selector,
                                                                                timeout=timeout)))
    ...
    def get_attribute(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.get_attribute", self._impl_obj.get_attribute(selector=selector,
                                                                                      name=name,
                                                                                      timeout=timeout)))
    ...
    def hover(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.hover", self._impl_obj.hover(selector=selector,
                                                                      modifiers=modifiers,
                                                                      position=position,
                                                                      timeout=timeout,
                                                                      force=force)))
    ...
    def select_option(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.select_option", self._impl_obj.select_option(selector=selector,
                                                                                      value=value,
                                                                                      index=index,
                                                                                      label=label,
                                                                                      element=mapping.to_impl(element),
    ...
    def set_input_files(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.set_input_files", self._impl_obj.set_input_files(selector=selector,
                                                                                          files=files,
                                                                                          timeout=timeout,
                                                                                          noWaitAfter=no_wait_after)))
    ...
    def type(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.type", self._impl_obj.type(selector=selector,
                                                                    text=text,
                                                                    delay=delay,
                                                                    timeout=timeout,
                                                                    noWaitAfter=no_wait_after)))
    ...
    def press(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.press", self._impl_obj.press(selector=selector,
                                                                      key=key,
                                                                      delay=delay,
                                                                      timeout=timeout,
                                                                      noWaitAfter=no_wait_after)))
    ...
    def check(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.check", self._impl_obj.check(selector=selector,
                                                                      timeout=timeout,
                                                                      force=force,
                                                                      noWaitAfter=no_wait_after)))
    ...
    def uncheck(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.uncheck", self._impl_obj.uncheck(selector=selector,
                                                                          timeout=timeout,
                                                                          force=force,
                                                                          noWaitAfter=no_wait_after)))
    ...
    def wait_for_timeout(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.wait_for_timeout", self._impl_obj.wait_for_timeout(timeout=timeout)))
    ...
    def wait_for_function(self,
        ...
        return mapping.from_impl(self._sync("page.wait_for_function", self._impl_obj.wait_for_function(expression=expression,
                                                                                        arg=mapping.to_impl(arg),
                                                                                        timeout=timeout,
                                                                                        polling=polling)))
    ...
    def pdf(self,
        ...
        return mapping.from_maybe_impl(self._sync("page.pdf", self._impl_obj.pdf(scale=scale,
    ...
    def expect_console_message(self,
                               ...
                               *,
                               timeout: float = None) -> EventContextManager["ConsoleMessage"]:
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_console_message(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_download(self,
                        predicate: typing.Optional[typing.Callable[["Download"], bool]] = None,
                        *,
                        timeout: float = None) -> EventContextManager["Download"]:
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_download(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_file_chooser(self,
                            predicate: typing.Optional[typing.Callable[["FileChooser"], bool]] = None,
                            *,
                            timeout: float = None) -> EventContextManager["FileChooser"]:
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_file_chooser(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)
    ...
    def expect_popup(self,
                     ...
                     *,
                     timeout: float = None) -> EventContextManager["Page"]:
        """Page.expect_popup
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_popup(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_request(self,
                       url_or_predicate: typing.Union[str, typing.Pattern, typing.Callable[["Request"], bool]],
                       *,
                       timeout: float = None) -> EventContextManager["Request"]:
        """Page.expect_request
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_request(url_or_predicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)
    ...
    def expect_response(self,
        ...
        EventContextManager[Response]
        """
        return EventContextManager(self, self._impl_obj.expect_response(url_or_predicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)

    def expect_worker(self,
                      predicate: typing.Optional[typing.Callable[["Worker"], bool]] = None,
                      *,
                      timeout: float = None) -> EventContextManager["Worker"]:
        """Page.expect_worker
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_worker(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)
...
class BrowserContext(SyncBase):
    ...
    def cookies(self,
        ...
        return mapping.from_impl_list(self._sync("browser_context.cookies", self._impl_obj.cookies(urls=urls)))
    ...
    def add_cookies(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.add_cookies", self._impl_obj.add_cookies(cookies=cookies)))
    ...
    def clear_cookies(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.clear_cookies", self._impl_obj.clear_cookies()))
    ...
    def grant_permissions(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.grant_permissions", self._impl_obj.grant_permissions(permissions=permissions,
                                                                                                         origin=origin)))
    ...
    def clear_permissions(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.clear_permissions", self._impl_obj.clear_permissions()))
    ...
    def set_geolocation(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.set_geolocation", self._impl_obj.set_geolocation(geolocation=geolocation)))
    ...
    def set_extra_http_headers(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.set_extra_http_headers", self._impl_obj.set_extra_http_headers(headers=mapping.to_impl(headers))))
    ...
    def set_offline(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.set_offline", self._impl_obj.set_offline(offline=offline)))
    ...
    def add_init_script(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.add_init_script", self._impl_obj.add_init_script(script=script,
                                                                                                     path=path)))
    ...
    def expose_binding(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.expose_binding", self._impl_obj.expose_binding(name=name,
                                                                                                   callback=self._wrap_handler(callback),
                                                                                                   handle=handle)))
    ...
    def expose_function(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.expose_function", self._impl_obj.expose_function(name=name,
                                                                                                     callback=self._wrap_handler(callback))))
    ...
    def route(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.route", self._impl_obj.route(url=self._wrap_handler(url),
                                                                                 handler=self._wrap_handler(handler))))
    ...
    def unroute(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.unroute", self._impl_obj.unroute(url=self._wrap_handler(url),
                                                                                     handler=self._wrap_handler(handler))))
    ...
    def close(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.close", self._impl_obj.close()))
    ...
    def storage_state(self,
        ...
        return mapping.from_impl(self._sync("browser_context.storage_state", self._impl_obj.storage_state(path=path)))
    ...
    def wait_for_event(self,
        ...
        return mapping.from_maybe_impl(self._sync("browser_context.wait_for_event", self._impl_obj.wait_for_event(event=event,
                                                                                                   predicate=self._wrap_handler(predicate),
                                                                                                   timeout=timeout)))
    ...
    def expect_page(self,
        ...
        EventContextManager[Page]
        """
        return EventContextManager(self, self._impl_obj.expect_page(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)
...
class CDPSession(SyncBase):
    ...
    def send(self,
        ...
        return mapping.from_maybe_impl(self._sync("cdp_session.send", self._impl_obj.send(method=method,
    ...
    def detach(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("cdp_session.detach", self._impl_obj.detach()))
...
class ChromiumBrowserContext(BrowserContext):
    ...
    def new_cdp_session(self,
        ...
        return mapping.from_impl(self._sync("chromium_browser_context.new_cdp_session", self._impl_obj.new_cdp_session(page=page._impl_obj)))
...
class Browser(SyncBase):
    ...
    def new_context(self,
        ...
        return mapping.from_impl(self._sync("browser.new_context", self._impl_obj.new_context(viewport=viewport,
    ...
    def new_page(self,
        ...
        return mapping.from_impl(self._sync("browser.new_page", self._impl_obj.new_page(viewport=viewport,
                                                                         noViewport=no_viewport,
                                                                         ignoreHTTPSErrors=ignore_https_errors,
                                                                         javaScriptEnabled=java_script_enabled,
                                                                         bypassCSP=bypass_csp,
    ...
    def close(self) -> NoneType:
        ...
        return mapping.from_maybe_impl(self._sync("browser.close", self._impl_obj.close()))
...
class BrowserType(SyncBase):
    ...
    def launch(self,
        ...
        return mapping.from_impl(self._sync("browser_type.launch", self._impl_obj.launch(executablePath=executable_path,
                                                                          args=args,
    ...
    def launch_persistent_context(self,
        ...
        return mapping.from_impl(self._sync("browser_type.launch_persistent_context", self._impl_obj.launch_persistent_context(userDataDir=user_data_dir,
